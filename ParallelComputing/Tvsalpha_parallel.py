...
cada uno de ellos se fusionan en un archivo  alvalues_n_parallel.dat
"""
...
n = 22 #orden del cero en el caso lineal
...
# Asignacion de los procesos
    process1 = Process(target = fun, args=(αlim, -2.0, 0.01, queue1))  
    process2 = Process(target = fun, args=(-1.99, 5.0, 0.01, queue2))
    process3 = Process(target = fun, args=(5.01, 12.0, 0.01, queue3))
    process4 = Process(target = fun, args=(12.01, 20, 0.01, queue4))  
...
#Se escriben los resultados en el archivo f
    f = open('alvalues_%d_parallel.dat'%n, 'w')
